...
public class BookingsPage extends AbstractPage {
	@FindBy(css = "ul[class*='bookings-listing']") //the container where bookings are stored
	WebElementFacade itemBookingsContainer;
	@FindBy(css = "button#item-return-item")
	WebElementFacade returnItemConfirmationPopup;
	@FindBy(css="ul[class*='nav-tabs']") //navigationTabs: booking requests/overdue bookings..etc..
	WebElementFacade headerContainer;


	public void checkBookingCategory(String bookingHeader){ //take the list of headers and click one of them
	...
	public void returnItem(String itemName) {// Click on an item
